        ...
        for task in tasks:
            for dataset in datasets:
                ...
                if task == "transport" and dataset == "mh" and method == "bc":
                    print_message(f"Skipping {method}_{task}_{dataset} as folder does not exist")
                    continue
                ...
                best_success_rate, best_epoch = run_trained_agent(args, max_parallel_rollouts=parallel_rollouts)
