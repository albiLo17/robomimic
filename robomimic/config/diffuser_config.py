...
class DiffuserConfig(BaseConfig):
    ALGO_NAME = "diffuser"
    ...
    def algo_config(self):
        ...
        """
        super(DiffuserConfig, self).algo_config()
        
        ################# Diffuser Algorithm Config #################
        self.algo.H = 10
        self.algo.gamma = 1.0
        self.algo.T = 100
        self.algo.drift_const = 0.001
    ...
    def experiment_config(self):
        ...
        """
        super(DiffuserConfig, self).experiment_config()
    ...
    def train_config(self):
        ...
        Update from subclass to set paper defaults for gym envs.
        """
        super(DiffuserConfig, self).train_config()
