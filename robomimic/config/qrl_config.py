...
class QuasimetricRLConfig(BaseConfig):
    ALGO_NAME = "qrl"
    ...
    def algo_config(self):
        ...
        """
        super(QuasimetricRLConfig, self).algo_config()
        ...
        self.algo.optim_params.critic.learning_rate.initial = 5e-4          # critic learning rate
        ...
        self.algo.optim_params.actor.learning_rate.initial = 3e-5          # actor learning rate
    ...
    def experiment_config(self):
        ...
        """
        super(QuasimetricRLConfig, self).experiment_config()
    ...
    def train_config(self):
        ...
        Update from subclass to set paper defaults for gym envs.
        """
        super(QuasimetricRLConfig, self).train_config()
